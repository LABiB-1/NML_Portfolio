...
const App: React.FC = () => {
  React.useEffect(() => {
    // Left intentionally empty or remove entirely if not needed
  }, []);
    ...
    <ThemeProvider>
      <div className="relative min-h-screen bg-white dark:bg-[#000000] text-[#111] dark:text-[rgba(255,255,255,0.9)] overflow-hidden selection:bg-portfolio-pink/30 selection:text-white transition-colors duration-500">
        ...
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute inset-[-50%] dark:hidden mesh-bg-light blur-[80px] opacity-80"></div>
          <div className="absolute inset-[-50%] hidden dark:block mesh-bg-dark blur-[100px] opacity-70"></div>
        </div>
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-white dark:from-[#000] to-transparent opacity-90"></div>
          <div className="absolute bottom-0 left-0 right-0 h-56 bg-gradient-to-t from-white dark:from-[#000] to-transparent opacity-90"></div>
